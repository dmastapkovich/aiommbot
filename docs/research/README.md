...
| `17-http-client-observability.md` | What hook surface, record fields and logging policy should the outbound Mattermost REST client expose, and how does it stay OpenTelemetry-compatible without depending on it? |
