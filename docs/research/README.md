...
| [`30-plugin-contract-mechanics.md`](30-plugin-contract-mechanics.md) | Beyond an explicit list and narrow Protocols, what does a plugin host specify — the contract version, lifecycle failure, the plugin-to-plugin channel, the refusals, the author's kit — and by which mechanism? |
