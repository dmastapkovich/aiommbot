...
| Extension points and plugin isolation (import-linter) | ADR-0002, ADR-0015 (contract), ADR-0016 (compose, check, start), ADR-0032 (layers and direction), ADR-0038 (the seam inventory), ADR-0040 (directories and contract shape), research 30, 33, 34 | style §8; §5, §8.6 | [§10.5](10-quality-requirements.md#105-modifiability) | in progress (contract version, collaboration channel, refusals and prohibitions pending #102; lifecycle failure and the author's kit pending #103) |
