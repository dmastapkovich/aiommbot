...
| [0030](0030-synchronous-callables-by-explicit-declaration.md) | A synchronous Handler or Provider is declared with `sync_to_thread` and runs in the Sync executor, abandonable at drain; Filters and Extractors run inline; everything else is a coroutine function (amends 0004, 0023) | accepted |
